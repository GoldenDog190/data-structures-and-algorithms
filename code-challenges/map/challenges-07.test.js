...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let newArrTwo = [];
  arr.forEach( loopTwoIn => {
    
    let loopTwo = Math.pow(2, loopTwoIn);
    newArrTwo.push(loopTwo);
...
const mapTwoToThe = (arr) => {
  ...
  const mapOne = arr.map(loopThree => {
    return Math.pow(2, loopThree);
